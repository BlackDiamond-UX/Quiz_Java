package com.youcode.quiz.Model;
...
//		textarea.setBackground(new Color(25,25,25));
		...
		time_label.setFont(new Font("MV Boli", Font.PLAIN, 8));
		time_label.setHorizontalAlignment(JTextField.CENTER);
		time_label.setText("You Have 5 Min");
	...
	Timer timer = new Timer(1000, new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (minutes == 1) {
				displayAnswer();
				System.out.println("noud tchelel hahahah !!");
			}
		}
	});
	...
	public void nextQuestion() {
		...
		if (index == 5 || index == 11 || index == 17) {
			...
			for (int i = 0; i < questions.length; i++) {
				if (options[index].length == 3 && minutes < 1) {
	...
	public void results() {
		if (index == 5 && correct_guesses < 2 && minutes < 1) {
			...
			textarea.setText("Rak KHsertii hahahah");
		...
		} else if (index == 11 && correct_guesses < 3 && minutes < 1) {
			buttonA.setVisible(false);
			buttonB.setVisible(false);
			buttonC.setVisible(false);
			...
			frame.add(number_right);
			frame.add(percentage);
		} else if (index == 17 && correct_guesses < 4 && minutes < 1) {
			...
			textfield.setText("RESULTS!");
			textarea.setText("Rak rbahtiii hahahah");
			answer_labelA.setVisible(false);
			answer_labelB.setVisible(false);
			answer_labelC.setVisible(false);
			...
			buttonC.setVisible(false);
			textfield.setText("RESULTS!");
			textarea.setText("noud tga3ed lwa9t sala");
			answer_labelA.setVisible(false);
			answer_labelB.setVisible(false);
			answer_labelC.setVisible(false);
			timer.stop();
